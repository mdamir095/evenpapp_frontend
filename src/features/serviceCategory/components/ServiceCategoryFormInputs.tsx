...
interface ServiceCategoryFormInputsProps {
  editingServiceCategory?: any;
  onFormSubmit?: () => void;
  onCancel?: () => void;
}

const ServiceCategoryFormInputs: React.FC<ServiceCategoryFormInputsProps> = ({ editingServiceCategory, onFormSubmit, onCancel }) => {
  const { id } = useParams();
